...
//  MyPlace
//
//  Created by Sreekanth tadi on 16/03/20.
  ...
  func scene(_ scene: UIScene, openURLContexts URLContexts: Set<UIOpenURLContext>) {
    ...
    func sceneDidEnterBackground(_ scene: UIScene) {
        ...
        // to restore the scene back to its current state.
         ...
         NotificationCenter.default.removeObserver(appDelegate, name: Notification.Name.reachabilityChanged, object: nil)
        
        if appDelegate.loginStatus == false
         {
