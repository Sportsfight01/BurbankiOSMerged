...
class MyPlaceContactsCell: UITableViewCell, MFMailComposeViewControllerDelegate {
   ...
   // @IBOutlet weak var phoneLabel: UILabel!
    ...
    override func awakeFromNib() {
        ...
        setAppearanceFor(view: nameLabel, backgroundColor: COLOR_CLEAR, textColor: APPCOLORS_3.HeaderFooter_white_BG, textFont: FONT_LABEL_SUB_HEADING(size: FONT_15))
        
        setAppearanceFor(view: fullNameLabel, backgroundColor: COLOR_CLEAR, textColor: APPCOLORS_3.Black_BG, textFont: FONT_LABEL_BODY (size: FONT_13))
        ...
        setAppearanceFor(view: mobileLabel, backgroundColor: COLOR_CLEAR, textColor: APPCOLORS_3.GreyTextFont, textFont: FONT_LABEL_BODY (size: FONT_12))
