...
class StudyVC: HomeDesignModalHeaderVC {
    ...
    func studyViewSetUp () {
        ...
        setAppearanceFor(view: study_lBStudy, backgroundColor: COLOR_CLEAR, textColor: APPCOLORS_3.Black_BG, textFont: FONT_LABEL_BODY (size: FONT_19))
        
        
        setAppearanceFor(view: study_btnMust, backgroundColor: APPCOLORS_3.HeaderFooter_white_BG, textColor: APPCOLORS_3.GreyTextFont, textFont: FONT_BUTTON_SUB_HEADING (size: FONT_14))
        setAppearanceFor(view: study_btnDont, backgroundColor: APPCOLORS_3.HeaderFooter_white_BG, textColor: APPCOLORS_3.GreyTextFont, textFont: FONT_BUTTON_SUB_HEADING (size: FONT_14))
        setAppearanceFor(view: study_btnDont_want_this, backgroundColor: APPCOLORS_3.HeaderFooter_white_BG, textColor: APPCOLORS_3.GreyTextFont, textFont: FONT_BUTTON_SUB_HEADING (size: FONT_14))
        
        
//        setBorder(view: study_btnMust, color: APPCOLORS_3.Orange_BG, width: 1.0)
//        setBorder(view: study_btnDont, color: APPCOLORS_3.Orange_BG, width: 1.0)
//        setBorder(view: study_btnDont_want_this, color: APPCOLORS_3.Orange_BG, width: 1.0)
