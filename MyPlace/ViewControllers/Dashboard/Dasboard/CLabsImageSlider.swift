...
//  Pods
//
//  Created by apple on 18/09/16. 85207
//
//
...
public class CLabsImageSlider:UIView,updateUI
{
    ...
    /**
     ...
     Throws : nothing
     */
    public func setUpView(imageSource:imageSrc,slideType:slideCase,isArrowBtnEnabled:Bool, contentMode : String)
    {
        switch imageSource{
    ...
    {
        if index > imageSourceArray.count{
