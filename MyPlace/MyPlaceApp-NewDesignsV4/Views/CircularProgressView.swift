...
class CircularProgressView : UIView {
    ...
    var lineWidth : CGFloat = 6 {
        didSet {
            progressLayer.lineWidth = lineWidth; trackLayer.lineWidth = lineWidth / 2
        }
    }
    var strokeColor = UIColor.lightGray.withAlphaComponent(0.3) {
        didSet {
            progressLayer.strokeColor = strokeColor.cgColor ; label.textColor = strokeColor
        }
    }
    ...
    var labelText : String? = "0% Progress" {
        didSet {
...
//        addAnimation(duration: 1.0)
        
    }
    
    func addAnimation(duration : CGFloat = 0.125)
    {
