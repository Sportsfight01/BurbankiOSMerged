...
class RecentSearchPopUp: UIViewController {
    ...
    func setupUI () {
        ...
        setAppearanceFor(view: btnShow, backgroundColor: APPCOLORS_3.Charcoal_BG, textColor: APPCOLORS_3.HeaderFooter_white_BG, textFont: FONT_BUTTON_SUB_HEADING (size: FONT_16))
