...
class FavouritesTVCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        setAppearanceFor(view: lBLine, backgroundColor: APPCOLORS_3.LightGreyDisabled_BG, textColor: APPCOLORS_3.HeaderFooter_white_BG, textFont: FONT_LABEL_LIGHT(size: FONT_12))
